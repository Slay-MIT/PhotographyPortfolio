...
function Header() {
  ...
  return (
    <div className="flex justify-center items-center h-screen scroll-smooth relative bottom-9">
      <motion.h1
        className="font-bold font-playwrite text-6xl dark:text-emerald-300 text-indigo-700 hover:text-sky-500 dark:hover:text-emerald-500 transition-all duration-500 hover:cursor-pointer text-shadow-lg text-pretty"
